...
public class EffectData
{
    ...
    */
    ...
    public EffectData(
        ...
        /*EffectData*/ string id = "", string name = "", int num = -1, bool affectsFainted = false, string desc = "", int[] drain = null, int duration = -1, EffectData effect = null, Globals.EffectTypes effectType = Globals.EffectTypes.Null, string isZ = "",
